...
<?= $this->Form->create($tenant, ['class' => 'form-horizontal']) ?>
    ...
    <div class="col-md-12">
        <div class="widget wgreen">
            ...
            <div class="widget-head">
                <div class="pull-left">Tenant</div>
            ...
            <div class="widget-content">
                <div class="padd">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="site"><?= __('Site') ?></label>
                        <?= $this->Form->control('site', ['class' => 'form-control', 'label' => false]) ?>
                    </div>
                </div>
            </div>
