...
<?= $this->Form->create($subpage, ['class' => 'form-horizontal']) ?>
    ...
    <div class="col-md-12">
        <div class="widget wgreen">
            ...
            <div class="widget-head">
                <div class="pull-left">Subpage</div>
            ...
            <div class="widget-content">
                <div class="padd">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label required-label" for="page_id"><?= __('Page_id') ?></label>
                        <?= $this->Form->control('page_id', ['options' => $pages, 'class' => 'form-control', 'label' => false]) ?>
                    </div>
                    <div class="form-group">
