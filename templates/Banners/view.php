    ...
    <div class="col-md-12">
        <div class="widget wgreen">
            ...
            <div class="widget-head">
                <div class="pull-left"><?= __("Banner") ?></div>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            <tr>
                                ...
                                <td class="col-lg-9"><?= h($banner->name) ?></td>
                            </tr>
                            <tr>
                                <th class="col-lg-3"><?= __('Tenant') ?></th>
                                <td class="col-lg-9"><?= $banner->tenant->name ?></td>
                            </tr>
                            <tr>
                                <th class="col-lg-3"><?= __('Id') ?></th>
                                <td class="col-lg-9"><?= $this->Number->format($banner->id) ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
