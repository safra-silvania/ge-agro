                ...
                <div class="padd">
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr>
                                <th class="col-lg-3"><?= __('Action') ?></th>
                                <td class="col-lg-9"><?= h($page->action) ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="col-lg-9"><?= $page->tenant->name ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="col-lg-3"><?= __('Order') ?></th>
                                <td class="col-lg-9"><?= $this->Number->format($page->order) ?></td>
                            </tr>
                            <tr>
