        ...
        <div class="widget wgreen">
            ...
            <div class="widget-content">
                <div class="padd">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label required-label" for="action"><?= __('Action') ?></label>
                        <?= $this->Form->control('action', ['class' => 'form-control', 'label' => false]) ?>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label required-label" for="order"><?= __('Order') ?></label>
                        <?= $this->Form->control('order', ['class' => 'form-control', 'label' => false]) ?>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="content"><?= __('Content') ?></label>
                        <?= $this->Form->control('content', ['class' => 'form-control', 'label' => false]) ?>
                    </div>
                </div>
            </div>
