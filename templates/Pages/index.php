                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= h($page->name) ?></td>
                                <td><?= h($page->action) ?></td>
                                <td><?= $page->has('page_status') ? $this->Html->link($page->page_status->name, ['controller' => 'PageStatuses', 'action' => 'view', $page->page_status->id]) : '' ?></td>
                                <td><?= $page->has('tenant') ? $this->Html->link($page->tenant->name, ['controller' => 'Tenants', 'action' => 'view', $page->tenant->id]) : '' ?></td>
