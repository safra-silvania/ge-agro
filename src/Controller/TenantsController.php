...
class TenantsController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Tenants->save($tenant)) {
                $this->Flash->successAdmin(__('The tenant has been saved.'));

                return $this->redirect(['action' => 'index']);
            }
            $this->Flash->errorAdmin(__('The tenant could not be saved. Please, try again.'));
        }
        $this->set(compact('tenant'));
    }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Tenants->delete($tenant)) {
            $this->Flash->successAdmin(__('The tenant has been deleted.'));
        } else {
            $this->Flash->errorAdmin(__('The tenant could not be deleted. Please, try again.'));
        }
