...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_status_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-11-15 12:05:57',
                'modified' => '2020-11-15 12:05:57',
            ],
        ];
        parent::init();
    }
